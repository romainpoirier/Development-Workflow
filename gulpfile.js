...
$.gulp.task('default', ['cache-bust', 'browsersync'], function() {
	...
	$.gulp.watch(config.paths.src.js + 'js/vendors/**/*.js', ['js-vendors']);
	$.gulp.watch(config.paths.src.js + 'js/scripts/**/*.js', ['js-scripts']);
	$.gulp.watch(config.paths.src.js + 'js/angular/**/*.js', ['angular-scripts']);
	$.gulp.watch(config.paths.src.js + 'js/angular/views/**/*.{html,tpl,twig}', ['angular-views']);
